...
const busPosterAreas = [
  ...
  { type: "neighborhood", name: "Bay Village" },
  { type: "neighborhood", name: "Beacon Hill" },
  { type: "neighborhood", name: "Brighton" },
  { type: "neighborhood", name: "Charlestown" },
  { type: "neighborhood", name: "Chinatown" },
  { type: "neighborhood", name: "Dorchester" },
  { type: "neighborhood", name: "Downtown" },
  { type: "neighborhood", name: "East Boston" },
  { type: "neighborhood", name: "Fenway" },
  { type: "neighborhood", name: "Harbor Islands" },
  { type: "neighborhood", name: "Hyde Park" },
  { type: "neighborhood", name: "Jamaica Plain" },
  { type: "neighborhood", name: "Leather District" },
  { type: "neighborhood", name: "Longwood" },
  { type: "neighborhood", name: "Mattapan" },
  { type: "neighborhood", name: "Mission Hill" },
  { type: "neighborhood", name: "North End" },
  { type: "neighborhood", name: "Roslindale" },
  { type: "neighborhood", name: "Roxbury" },
  { type: "neighborhood", name: "South Boston" },
  { type: "neighborhood", name: "South Boston Waterfront" },
  { type: "neighborhood", name: "South End" },
  { type: "neighborhood", name: "West End" },
  { type: "neighborhood", name: "West Roxbury" },
];
